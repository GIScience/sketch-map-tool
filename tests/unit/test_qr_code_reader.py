...
def test_read_qr_code(qr_code_img):
    ...
    assert qr_code_reader.read(qr_code_img) == "Sketch Map Tool"


def test_read_qr_code_sketch_map(qr_code_sketch_map):
    assert (
        qr_code_reader.read(qr_code_sketch_map)
...
def test_read_qr_code_big(qr_code_img_big):
    ...
    """
    assert qr_code_reader.read(qr_code_img_big) == "Sketch Map Tool"
