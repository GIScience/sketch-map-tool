...
RESULT_COULD_NOT_BE_LOADED = (
    "ERROR: The result file could not be loaded. Please make sure the "
    "URL is correct."
)

BBOX_TOO_BIG = (
    "Invalid input: Selected bounding box is bigger than 50 km^2. Please select a "
