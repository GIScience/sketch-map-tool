...
export class UserLayerControl extends Control {
    ...
    private readonly addLayerButton: HTMLDivElement;
...
`;
    ...
    showUserLayerButton() {
        this.addLayerButton.classList.add("hidden");
        this.userLayerButton.classList.remove("hidden");
    }

    showAddLayerButton() {
        this.addLayerButton.classList.remove("hidden");
        this.userLayerButton.classList.add("hidden");
    }
}
